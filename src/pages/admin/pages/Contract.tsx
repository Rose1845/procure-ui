...
function Contract() {
  ...
  const [searchParams, setSearchParams] = React.useState<{ contractTitle?: string, startDate?: string, endDate?: string }>({});
          ...
          <div className="flex mt-3 flex-col justify-start">
            ...
            <div className="flex flex-col space-y-3">
              ...
              <select
                ...
                className="bg-white bcontract bcontract-gray-300 rounded px-3 py-1"
              >
                <option selected value="">ALL CONTRACT STATUS</option>
                <option value="ACCEPTED">ACCEPTED</option>
                <option value="EXPIRED">EXPIRED</option>
                <option value="PENDING_SUPPLIER_ACCEPTANCE">PENDING_SUPPLIER_ACCEPTANCE</option>
        ...
        <div className="max-w-7xl mx-auto pt-16 ">
          <div className="w-full overflow-hidden rounded-lg shadow-xs">
            <div className="flex flex-row space-x-3">
              ...
              <th className="px-4 py-3 cursor-pointer" onClick={() => handleSortChange("contractTitle")}>
                Contract Title
              </th>
              <th className="px-4 py-3 cursor-pointer" onClick={() => handleSortChange("contractType")}>
                Contract Type
              </th>
              <th className="px-4 py-3 cursor-pointer" onClick={() => handleSortChange("contractStatus")}>
                Status
              </th>
            ...
            <div className="w-full overflow-x-auto">
              <table className="w-full">
                ...
                <tbody className="bg-white divide-y dark:divide-gray-500">
                  {contracts.length == 0 ? (<tr className="text-gray-700 dark:text-gray-400">
            ...
            {
              contracts.length > 0 && (
                <div className="grid px-4 py-3 text-xs font-semibold tracking-wide text-gray-500 uppercase bcontract-t dark:bcontract-gray-700 bg-gray-50 sm:grid-cols-9 dark:text-gray-400">
