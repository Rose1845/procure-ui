...
interface Props {
    deliveredItem: Delivery;
}

const DeliveredItemComponent: React.FC<Props> = () => {
    ...
    return (
        <div>
            ...
            <p>Purchase Order Title: {deliveredItem.purchaseOrder.purchaseOrderTitle}</p>
            {/* Add more details as needed */}
            <p>PO Status: {deliveredItem.purchaseOrder.approvalStatus}</p>
            <p>Issued On: {new Date(deliveredItem.purchaseOrder.createdAt).toLocaleDateString()}</p>
            <p>Received On: {deliveredItem.receivedOn}</p>
        </div>
    );
};

export default DeliveredItemComponent;
