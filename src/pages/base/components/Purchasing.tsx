          ...
          <section className="mx-auto container py-20 ">
            <div className="flex justify-center items-center flex-col">
              <div className="lg:text-6xl md:text-5xl text-4xl font-black leading-10 text-center text-gray-800 ">
                ...
                <p className="text-sm mt-3 text-center">ProcureSwift’s online purchasing system provides management with everything they need to know about their business
                </p>
              </div>
              <div className="pt-24 grid lg:grid-cols-3 md:grid-cols-2 justify-center items-center xl:gap-y-16 gap-y-20 gap-x-16 lg:gap-x-20 xl:gap-x-0 lg:px-10 xl:px-0">
                ...
                <div className="cursor-pointer hover:shadow py-6 xl:px-4 rounded xl:w-96 w-60 flex justify-center items-center flex-col">
                  ...
                  <div className="text-gray-600  mt-2 text-lg text-center">
                    <p>Get employees to submit a simple internal form to centralise purchasing</p>
                  </div>
                </div>
                <div className="cursor-pointer hover:shadow py-6 xl:px-4 rounded xl:w-96 w-60 flex justify-center items-center flex-col">
                  <div className="mb-6">
          ...
          <section className="mx-auto container py-20 ">
            <div className="flex justify-center items-center flex-col">
              <div className="lg:text-6xl md:text-5xl text-4xl font-black leading-10 text-center text-gray-800 ">
                ...
                <p className="text-sm mt-3 text-center">With a simple, intuitive user interface,
                  it’s never been easier to operate the procurement process within your team.
                </p>
              </div>
              <div className="pt-24 grid lg:grid-cols-3 md:grid-cols-2 justify-center items-center xl:gap-y-16 gap-y-20 gap-x-16 lg:gap-x-20 xl:gap-x-0 lg:px-10 xl:px-0">
                <div className="cursor-pointer hover:shadow py-6 xl:px-4 rounded xl:w-96 w-60 flex justify-center items-center flex-col">
                ...
                <div className="cursor-pointer hover:shadow py-6 xl:px-4 rounded xl:w-96 w-60 flex justify-center items-center flex-col">
                  ...
                  <div className="text-gray-600  mt-2 text-lg text-center">
                    <p>Have your record to match that of your purchase orders</p>
                  </div>
                </div>
                <div className="cursor-pointer hover:shadow py-6 xl:px-4 rounded xl:w-96 w-60 flex justify-center items-center flex-col">
                  <div className="mb-6">
                  ...
                  <div className="text-gray-600  mt-2 text-lg text-center">
                    <p>Store and manage your supplier contracts in an easy accessible repository.</p>
                  </div>
                </div>
                {/* <div className="cursor-pointer hover:shadow py-6 xl:px-4 rounded xl:w-96 w-60 flex justify-center items-center flex-col">
                <div className="mb-6">
