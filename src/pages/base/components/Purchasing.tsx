      ...
      <section className="mx-auto container bg-white pt-16">
        <div className="px-4 lg:px-0 py-10">
          <div role="contentinfo" className="flex items-center flex-col px-4">
            <h1 className="focus:outline-none uppercase text-6xl text-center text-gray-800 leading-none">
              FEATURES
            </h1>
            <p className="focus:outline-none text-md capitalize lg:text-xl pt-4  text-center leading-tight text-gray-800 lg:w-7/12 md:w-9/12 xl:w-5/12">
              procurement software gives you access to a wide range of features
            </p>
          </div>
        </div>
      </section>
      <div className="bg-gray-100">
          ...
          <section className="mx-auto container py-20 ">
            <div className="flex justify-center items-center flex-col">
              <div className="lg:text-6xl md:text-5xl text-4xl font-black leading-10 text-center text-gray-800 ">
                ...
                <p className="text-lg mt-3 text-center max-w-[60ch] font-normal">
                  ProcureSwift’s online purchasing system provides management
                  with everything they need to know about their business
                </p>
              </div>
              <div className="pt-24 grid lg:grid-cols-3 md:grid-cols-2 justify-center items-center xl:gap-y-16 gap-y-20 gap-x-16 lg:gap-x-20 xl:gap-x-0 lg:px-10 xl:px-0">
                ...
                <div className="cursor-pointer bg-white ml-3 hover:shadow py-6 xl:px-4 rounded xl:w-96 w-60 flex justify-center items-center flex-col">
                  ...
                  <div className="text-gray-800 bg-white ml-3 text-2xl font-semibold text-center">
                    <h2>Suppliers List</h2>
                  </div>
                  <div className="text-gray-600  mt-2 text-lg text-center">
                    <p>
                      Get employees to submit a simple internal form to
        ...
        <div className="bg-[#FEF8EB]">
          <section className="mx-auto container py-20 ">
            <div className="flex justify-center items-center flex-col">
              <div className="lg:text-6xl md:text-5xl text-4xl font-black leading-10 text-center text-gray-800 ">
                <h2>Operational Tool</h2>
                <p className="text-sm mt-3 text-center">
                  With a simple, intuitive user interface, it’s never been
              ...
              <div className="pt-24 grid lg:grid-cols-3 md:grid-cols-2 justify-center items-center xl:gap-y-16 gap-y-20 gap-x-16 lg:gap-x-20 xl:gap-x-0 lg:px-10 xl:px-0">
                ...
                <div className="cursor-pointer hover:shadow py-6 xl:px-4 rounded xl:w-96 w-60 flex justify-center items-center flex-col">
                  ...
                  <div className="text-gray-600  mt-2 text-lg text-center">
                    <p>
                      Have your record to match that of your purchase orders
                    </p>
                  </div>
                </div>
                <div className="cursor-pointer hover:shadow py-6 xl:px-4 rounded xl:w-96 w-60 flex justify-center items-center flex-col">
                  ...
                  <div className="text-gray-600  mt-2 text-lg text-center">
                    <p>
                      Store and manage your supplier contracts in an easy
