...
function ChangePassword() {
    ...
    const handleSubmit = async (e: { preventDefault: () => void; }) => {
        ...
        try {
            const response = await publicApi.post(`/forgotPassword/changePassword/${email}`, credentials);
                        ...
                        <div className="flex flex-col mb-6">
                            ...
                            <div className="relative">
                                ...
                                <input type={showPassword ? "text" : "password"}
                                    ...
                                    value={credentials.password} className="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400" placeholder="Password" />
                                <button
                        ...
                        <div className="flex flex-col mb-6">
                            ...
                            <div className="relative">
                                ...
                                <input type={showPassword ? "text" : "password"}
                                    ...
                                    id="repeatPassord"
                                    onChange={handleChange}
                                    value={credentials.repeatPassord} className="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400" placeholder="Password" />
                                <button
                                    onClick={handleTogglePassword}
                                    className="absolute inset-y-0 right-0 flex items-center px-3 text-gray-400"
                                >
