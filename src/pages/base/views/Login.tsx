            ...
            <div className="flex flex-col mb-6">
              ...
              <div className="relative">
                ...
                <input name="username"
                  ...
                  value={credentials.username} className="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400" placeholder="username" />
              </div>
            </div>
            <div className="flex flex-col mb-6">
